...
class vehicle2d_single_track(vehicle2d):
    ...
    def draw_vehicle(self):
        ...
        tires_headings_bframe = np.array([self.front_wheel_angle,0]) # assume rear wheel is always straight forward
        ...
        self.front_tire.draw_tire(tire_pose_front)
        self.rear_tire.draw_tire(tire_pose_rear)
        plt.plot()